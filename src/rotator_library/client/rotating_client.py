...
class RotatingClient:
    ...
    async def acompletion(
        ...
        **kwargs,
        ...
        """Dispatch completion requests with optional alias/fallback routing."""
        ...
        try:
            ...
            lib_logger.info(
                ...
                f"{', '.join(target.provider for target in fallback_targets)}"
            )
            return await self._cross_provider_executor.execute(
    ...
    async def get_available_models(
        ...
        models = await self._model_discovery.get_available_models(
            provider,
        ...
        if force_refresh and self._latest_registry.has_rules():
    ...
    def _get_provider_instance(self, provider: str) -> Optional[Any]:
        ...
        if provider not in self._provider_instances:
            ...
            if plugin_class:
                ...
                if hasattr(instance, "_proxy_config") and hasattr(self, "_proxy_config"):
